				...
				<ul id="shipping_method">
					<?php foreach ( $available_methods as $method ) : ?>
						<li>
							...
							<label class="treti-shipping" for="shipping_method_<?php echo $index; ?>_<?php echo sanitize_title( $method->id ); ?>"><?php echo wp_kses_post( wc_cart_totals_shipping_method_label( $method ) ); ?></label> 
