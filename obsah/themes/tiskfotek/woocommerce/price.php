...
jQuery( document ).ready(function() {   
    ...
    jQuery('.nastavit-celkem .format select').val(function() {
        jQuery(".nastavit-celkem .velke-formaty .chosen-container").addClass("chosen-disabled");
        jQuery(".nastavit-celkem .material-pro-velke-formaty").hide();
        jQuery(".nastavit-celkem .material-pro-fotoobrazy").hide();
        jQuery(".nastavit-celkem .material").show();
        jQuery(".nastavit-celkem .material .chosen-container").addClass("chosen-disabled");
        jQuery(".nastavit-celkem .deska .chosen-container.chosen-container-single.chosen-container-single-nosearch").addClass("chosen-disabled");
    });
    //zjištění formátu:
    jQuery('.nastavit-celkem .format select').change(function() {
        ...
        if( vysledek == "Velké formáty"){
            jQuery(".nastavit-celkem .velke-formaty .chosen-container").removeClass("chosen-disabled");
            jQuery(".nastavit-celkem .material-pro-velke-formaty").hide();
            jQuery(".nastavit-celkem .material").show();
            jQuery(".nastavit-celkem .material .chosen-container").addClass("chosen-disabled");
            jQuery(".nastavit-celkem .material-pro-fotoobrazy").hide();
            jQuery(".nastavit-celkem .deska .chosen-container").removeClass("chosen-disabled");
        }
        else if(vysledek == "Obraz na plátně"){
            jQuery(".nastavit-celkem .velke-formaty .chosen-container").addClass("chosen-disabled");
            jQuery(".nastavit-celkem .material-pro-fotoobrazy").show();
            jQuery(".nastavit-celkem .material-pro-velke-formaty").hide();
            jQuery(".nastavit-celkem .material").hide();
            jQuery(".nastavit-celkem .deska .chosen-container").addClass("chosen-disabled");
        }
            ...
            jQuery(".nastavit-celkem .deska").show();
            jQuery(".nastavit-celkem .deska .chosen-container").removeClass("chosen-disabled");
        }
        //nic není zakliknuto
        else {
...
<script>
    ...
    jQuery(function(){
        jQuery(".nastavit-hromadne").click(function(){
            jQuery('.addon-wrap-3032-velke-formaty select.addon-select').val( jQuery('.nastavit-celkem .addon-3032-velke-formaty').val() );  
            jQuery('.addon-wrap-3032-velke-formaty select.addon-select').trigger("chosen:updated");
        })
	});
    ...
    jQuery(function(){
        jQuery(".nastavit-hromadne").click(function(){
            jQuery('.addon-wrap-3032-material-pro-velke-formaty select.addon-select').val( jQuery('.nastavit-celkem .addon-3032-material-pro-velke-formaty').val() );  
            jQuery('.addon-wrap-3032-material-pro-velke-formaty select.addon-select').trigger("chosen:updated");
        })
	});
    //typ
    jQuery(function(){
    ...
    jQuery(function(){
        jQuery(".nastavit-hromadne").click(function(){
                ...
                if( vysledek == "10x15-2" || vysledek == "13x18-3" || vysledek == "15x20-4" || vysledek == "15x21-5" || vysledek == "15x23-6"){
                    jQuery(".pole-blok .addon-wrap-3032-velke-formaty .chosen-container").addClass("chosen-disabled");
                    jQuery(".pole-blok .addon-wrap-3032-material-pro-fotoobrazy").hide();
                    jQuery(".pole-blok .addon-wrap-3032-material-pro-velke-formaty").hide();
                ...
                if(vysledek == "fotoobraz-8"){
                    jQuery(".pole-blok .addon-wrap-3032-velke-formaty .chosen-container").addClass("chosen-disabled");
                    jQuery(".pole-blok .addon-wrap-3032-material-pro-fotoobrazy").show();
                    jQuery(".pole-blok .addon-wrap-3032-material-pro-velke-formaty").hide();
                ...
                if(vysledek == "30x40-10" ||
                   ...
                   vysledek == "a3-18" ||
                   vysledek == "a2-19"){
                    jQuery(".pole-blok .addon-wrap-3032-velke-formaty .chosen-container").removeClass("chosen-disabled");
                    jQuery(".nastavit-celkem .material-pro-velke-formaty").hide();
                    jQuery(".nastavit-celkem .material").show();
                    jQuery(".nastavit-celkem .material .chosen-container").addClass("chosen-disabled");
                    jQuery(".pole-blok .addon-wrap-3032-material-pro-fotoobrazy").hide();
            ...
            <div class="nastavit-celkem">
                ...
                <div class="col-md-2 format">
					...
					<option value="">Formát</option>
                               ...
                               <div class="col-md-2 velke-formaty">
                   <select class="addon addon-select chosen-select addon-3032-velke-formaty" name="addon-3032-velke-formaty" style="display: none;">
              ...
              <div class="material-pro-fotoobrazy">
               <select class="addon addon-select chosen-select addon-3032-material-pro-fotoobrazy" name="addon-3032-material-pro-fotoobrazy" style="display: none;">
               ...
               <div class="material-pro-velke-formaty">
               <select class="addon addon-select chosen-select addon-3032-material-pro-velke-formaty" name="addon-3032-material-pro-velke-formaty" style="display: none;">
                ...
                <div class="col-md-2 deska">
                    <select class="addon addon-select chosen-select addon-3032-deska" name="addon-3032-deska" style="display: none;">

					<option value="">Deska</option>
		        
		            			<option data-price="27.17" value="deska-rayboard-5mm-1">Deska Rayboard 5mm (27.17&nbsp;Kč)</option>
                                		            			<option data-price="39.2" value="deska-rayboard-10mm-2">Deska Rayboard 10mm (39.20&nbsp;Kč)</option>
