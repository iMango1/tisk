   ...
   <article class="comment" id="comment-<?php comment_ID(); ?>"> 
        ...
        <?php echo get_avatar( $comment, apply_filters( 'woocommerce_review_gravatar_size', '60' ), '', get_comment_author() ); ?>
         ...
         <div class="comment-content">
            ...
            <h5 class="comment-author skew-25 woo" itemprop="author">
                <span class="author-name skew25"><?php comment_author(); ?></span>
                <span class="item-rating skew25">
                ...
                <span class="comment-date skew25"><time itemprop="datePublished" datetime="<?php echo get_comment_date( 'c' ); ?>"><?php echo get_comment_date( __( get_option( 'date_format' ), 'woocommerce' ) ); ?></time></span>
            </h5>
             <?php
