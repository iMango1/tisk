...
$output = '<div class="' . $css_class .  ' '.$barsstyle .'">';
...
foreach ( $graph_lines_data as $line ) {
	...
	$output .= '<span class="vc_bar ' .$bgcolor. $bar_options . '" data-percentage-value="' . ( $percentage_value ) . '" data-value="' . $line['value'] . '"' . $line['bgcolor'] . '></span>';
	$output .= '</div>';
}
