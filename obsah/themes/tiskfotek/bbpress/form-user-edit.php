...
<form id="bbp-your-profile" action="<?php bbp_user_profile_edit_url( bbp_get_displayed_user_id() ); ?>" method="post" enctype="multipart/form-data" class="contact-form">

	<h3 class="block-head"><?php _e( 'Name', 'bbpress' ) ?></h3>
	...
	<fieldset class="bbp-form">
		...
		<div>
			...
			<input type="text" name="first_name" id="first_name" value="<?php bbp_displayed_user_field( 'first_name', 'edit' ); ?>" class="" tabindex="<?php bbp_tab_index(); ?>" />
		</div>

		<div>
			<label for="last_name"><?php _e( 'Last Name', 'bbpress' ) ?></label>
			<input type="text" name="last_name" id="last_name" value="<?php bbp_displayed_user_field( 'last_name', 'edit' ); ?>" class="" tabindex="<?php bbp_tab_index(); ?>" />
		</div>

		<div>
			<label for="nickname"><?php _e( 'Nickname', 'bbpress' ); ?></label>
			<input type="text" name="nickname" id="nickname" value="<?php bbp_displayed_user_field( 'nickname', 'edit' ); ?>" class="" tabindex="<?php bbp_tab_index(); ?>" />
		</div>
	...
	<h3 class="block-head"><?php _e( 'Contact Info', 'bbpress' ) ?></h3>
	...
	<fieldset class="bbp-form">
		...
		<div>
			...
			<input type="text" name="url" id="url" value="<?php bbp_displayed_user_field( 'user_url', 'edit' ); ?>" class="code" tabindex="<?php bbp_tab_index(); ?>" />
		</div>
		...
		<?php foreach ( bbp_edit_user_contact_methods() as $name => $desc ) : ?>
			...
			<div>
				...
				<input type="text" name="<?php echo esc_attr( $name ); ?>" id="<?php echo esc_attr( $name ); ?>" value="<?php bbp_displayed_user_field( $name, 'edit' ); ?>" class="" tabindex="<?php bbp_tab_index(); ?>" />
			</div>
	...
	<h3 class="block-head"><?php bbp_is_user_home_edit() ? _e( 'About Yourself', 'bbpress' ) : _e( 'About the user', 'bbpress' ); ?></h3>
	...
	<h3 class="block-head"><?php _e( 'Account', 'bbpress' ) ?></h3>
	...
	<fieldset class="bbp-form">
		...
		<div>
			...
			<input type="text" name="user_login" id="user_login" value="<?php bbp_displayed_user_field( 'user_login', 'edit' ); ?>" disabled="disabled" class="" tabindex="<?php bbp_tab_index(); ?>" />
		</div>

		<div>
			<label for="email"><?php _e( 'Email', 'bbpress' ); ?></label>

			<input type="text" name="email" id="email" value="<?php bbp_displayed_user_field( 'user_email', 'edit' ); ?>" class="" tabindex="<?php bbp_tab_index(); ?>" />
	...
	<?php if ( current_user_can( 'edit_users' ) && ! bbp_is_user_home_edit() ) : ?>
		...
		<h3 class="block-head"><?php _e( 'User Role', 'bbpress' ) ?></h3>
	...
	<div class="right-text">
			...
			<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_user_edit_submit" name="bbp_user_edit_submit" class="btn btn-large main-bg"><?php bbp_is_user_home_edit() ? _e( 'Update Profile', 'bbpress' ) : _e( 'Update User', 'bbpress' ); ?></button>
	</div>
