<?php
    ...
    if($cust_title == '1'){
       ...
       $subtitl_text = '<h3 class="sub-title fx" data-animate="fadeInRight">'.esc_html(get_post_meta(c_page_ID(),'custom_subtitle',true)).'</h3>'; 
    }else{
       $it_page_title = it_custom_page_title(); 
    }
?>
        ...
        <div class="row">
            <div class="col-md-12 lft-title">
                <div class="title-container">
                    <div class="left"><i class="fa page-icon <?php it_page_title_icon(); ?> main-bg fx" data-animate="fadeInLeft"></i></div>
                    <div class="left"><h1 class="fx" data-animate="fadeInLeft"><?php echo $it_page_title; ?></h1>
                    <?php echo $subtitl_text; ?></div>
                </div>
            </div>
