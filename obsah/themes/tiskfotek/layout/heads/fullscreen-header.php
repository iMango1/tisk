...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class('one-page'); ?>>
        ...
        <div id="headWrapper" class="fullscreen-head">
                
                <!-- Logo, global navigation menu and search start -->
                <header class="top-head head-7" <?php echo $clsticky; ?>>
                    <div class="container">
                        <div class="row">
                            <div class="right top-menu one-page custom-head">
                                ...
                                if ( has_nav_menu( 'global-menu' ) ) {
                                    ...
                                    echo '<span class="menu-message">Please go to admin panel > Menus > select Global menu and add items to it.</span>';
                                }
                                ?>
                            </div>
                            <div class="logo left">
