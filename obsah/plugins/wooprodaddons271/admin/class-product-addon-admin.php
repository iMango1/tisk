...
class Product_Addon_Admin {
	...
	public function admin_menu() {
		$page = add_submenu_page( 'edit.php?post_type=product', __( 'Sestavy polí', 'woocommerce-product-addons' ), __( 'Sestavy polí', 'woocommerce-product-addons' ), 'manage_woocommerce', 'global_addons', array( $this, 'global_addons_admin' ) );
