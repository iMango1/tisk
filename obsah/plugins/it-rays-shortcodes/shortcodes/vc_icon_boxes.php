...
function it_iconbox_shortcode($atts, $content=null){
    ...
    if($iconbox_style == "1"){
      ...
      $output .= '<i class="fa '.$iconbox_icon.'"></i>';
      $output .= '<h3>'.esc_html($iconbox_title).'</h3>';
      $output .= '<p>'.$content.'</p>';
      $output .= '<a class="more-btn" href="'.esc_url($iconbox_more).'">'.__('Read More','itrays').'</a>';
      $output .= '</div>';
      $output .= '</div>';
      ...
      $output .= '<i class="icon main-bg fa '.$iconbox_icon.'"></i>';
      $output .= '<h4 class="main-color"><span data-hover="'.esc_html($iconbox_title).'">'.esc_html($iconbox_title).'</span></h4>';
      $output .= '</div>';
      $output .= '<div class="clearfix"></div>';
      $output .= '<p class="mediumFont">'.$content.'</p>';
      $output .= '<a class="r-more main-color" href="'.esc_url($iconbox_more).'">'.__('Read More','itrays').'</a>';
      $output .= '</div>'; 
   }else if($iconbox_style == "9"){
      $output  = '<div class="icon-box icon-box-9'.$fx.'" '.$data_anim.$data_del.$data_dur.'>';
      $output .= '<a href="'.esc_url($iconbox_more).'"><div class="icon_container main-bg"><i class="icon '.$iconbox_icon.'"></i></div></a>';
      $output .= '<h3>'.esc_html($iconbox_title).'</h3>';
      $output .= '<p>'.$content.'</p>';
      $output .= '</div>';
